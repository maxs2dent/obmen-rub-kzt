              ...
              mainEntity: [
                ...
                },
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text:
                      "Обмен происходит по актуальному курсу RUB/KZT, который отображается перед оформлением заявки и НО также он можнт изменстья в зависимости от волотильности рынка."
                  }
                },
                {
                  "@type": "Question",
