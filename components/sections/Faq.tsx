    ...
    <section className="w-full px-4 py-10 bg-gray-50">
      ...
      <div className="space-y-3">
        ...
        <details className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <p className="mt-2 text-gray-600">
            Обмен происходит по актуальному курсу, который отображается перед оформлением заявки и НО также он может незначительно измениться в зависимости от волатильности рынка.
          </p>
        </details>
